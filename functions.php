...
function themetim_scripts() {
	wp_enqueue_style( 'themetim-body-fonts', '//fonts.googleapis.com/css?family=' . esc_attr(get_theme_mod('body_font_family','Source+Sans+Pro').":".get_theme_mod('body_font_weight','400')) );
	wp_enqueue_style( 'themetim-heading-fonts', '//fonts.googleapis.com/css?family=' . esc_attr(get_theme_mod('heading_font_family','Source+Sans+Pro').":".get_theme_mod('heading_font_weight','700')) );
	wp_enqueue_style( 'themetim-animate', get_template_directory_uri() . '/assets/css/animate.min.css', array(), '3.5.1' );
	wp_enqueue_style( 'themetim-font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), '4.7.0' );
	...
	wp_enqueue_style( 'themetim-themetim', get_template_directory_uri() . '/assets/css/themetim.css', array(), '1.0.0' );
	wp_enqueue_script( 'themetim-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array(), '3.3.6', true );
	wp_enqueue_style( 'themetim-mobile', get_template_directory_uri() . '/assets/css/mobile.css', array(), '1.0.0' );
	wp_enqueue_script( 'themetim-mobile-customized', get_template_directory_uri() . '/assets/js/jquery.mobile.customized.min.js', array(), '1.4.5', true );
